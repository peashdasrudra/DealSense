...
import { BookTriageModal } from "./BookTriageModal";
...
export const ExecutiveAuditModal: React.FC<ExecutiveAuditModalProps> = ({
  ...
  const [bookingTier, setBookingTier] = useState<"pilot-99" | "retainer-2500">("pilot-99");
  ...
  const handleOpenBooking = (tier: "pilot-99" | "retainer-2500") => {
    setBookingTier(tier);
  ...
  return (
    <>
          ...
          <div style={{ padding: "28px" }}>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                <button
                  onClick={() => handleOpenBooking("pilot-99")}
                  style={{
                    padding: "11px 20px",
                    background: "#ff5c35",
                    color: "#ffffff",
                ...
                <button
                  onClick={() => handleOpenBooking("retainer-2500")}
                  style={{
                    padding: "11px 20px",
                    background: "rgba(0, 164, 189, 0.15)",
              ...
              <div style={{ marginTop: 12, fontSize: "11.5px", color: "rgba(255,255,255,0.6)" }}>
      ...
      <BookTriageModal
        ...
        atRiskCapital={`$${(atRiskValue / 1000).toFixed(0)}K`}
      />
    </>
  );
};
