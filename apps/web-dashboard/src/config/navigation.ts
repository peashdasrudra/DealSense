...
export const CONTACT_LINKS = {
  ...
  CALENDLY: "https://calendly.com/pdrpeash/onboarding-with-peash",
...
export const ALL_NAV_ITEMS: NavLinkItem[] = [
  ...
  {
    id: "nav-checkout-agency",
    label: "Checkout: Agency Master Fleet ($3,500)",
    path: "/checkout?tier=agency-3500",
    category: "Landing & Marketing",
    type: "route",
    badge: "72% OFF",
    description: "HubSpot-level SaaS payment & provisioning page for $3,500 Agency Master Fleet.",
  },
  {
    id: "nav-checkout-deploy",
    label: "Checkout: Single Portal Deploy ($1,500)",
    path: "/checkout?tier=deploy-1500",
    category: "Landing & Marketing",
    type: "route",
    badge: "70% OFF",
    description: "HubSpot-level SaaS payment & provisioning page for $1,500 Single Portal Stack.",
  },
  {
    id: "nav-checkout-audit",
    label: "Checkout: Pilot Deal Risk Audit ($99)",
    path: "/checkout?tier=audit-99",
    category: "Landing & Marketing",
    type: "route",
    badge: "$99 PILOT",
    description: "HubSpot-level SaaS payment & provisioning page for $99 Risk Audit Dossier.",
  },
  {
    id: "nav-checkout-custom",
    label: "Checkout: Custom AI HubSpot App ($1,500)",
    path: "/checkout?tier=custom-app",
    category: "Landing & Marketing",
    type: "route",
    badge: "SPRINT",
    description: "HubSpot-level SaaS payment & provisioning page for 5-10 day rapid AI app sprint.",
  },
