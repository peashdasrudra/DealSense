...
const PACKAGES = [
  ...
  },
  {
    ...
    crossed: "$2,500",
    timeline: "48h",
    tagline: "Charge your client $2,500/mo → $30K/yr (100× ROI)",
    guarantee: "30-day performance guarantee + complete code handover",
    features: [
      "Everything in the $29 Audit tier",
  ...
  },
  {
    ...
    crossed: "$5,000",
    timeline: "5 days",
    tagline: "10 clients × $2K/mo = $240K/yr recurring (343× ROI)",
    ...
    cta: "Lock In Agency Fleet ($699) →",
    highlight: false,
  },
];

const FAQS = [
  { q: "How long does deployment take?", a: "The $29 audit delivers results in 24–48 hours. Single portal deployment takes 48 hours. Agency fleet setup takes 5 business days with dedicated engineering support." },
  ...
  { q: "What if it doesn't find enough at-risk pipeline?", a: "The $29 audit comes with an unconditional 100% money-back guarantee. If we don't surface at least $25K in at-risk pipeline value, you get a full refund, no questions asked." },
