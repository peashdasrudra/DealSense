...
const PRICING_TIERS: Record<TierKey, BaseTierPlan> = {
  "agency-3500": {
    id: "agency-3500",
    name: "Elite Solutions Partner Fleet",
    tagline: "Multi-tenant CRM revenue intelligence engine for HubSpot Solutions Partners.",
    badge: "RECOMMENDED · PARTNER FLEET",
    badgeColor: "#ff5c35",
    popular: true,
    baseUsdPrice: 3500,
    ...
    deliverables: [
      { icon: "👑", title: "Unlimited Multi-Tenant Client Portals", subtitle: "Isolated multi-client workspace switcher with custom domain and co-branded reporting" },
