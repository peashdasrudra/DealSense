...
export const StakeholderMatrix: React.FC = () => {
  ...
  <div style={{ display: "flex", flexDirection: "column", gap: "var(--sp-6)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: "11.5px", color: "#a5c2c4", fontWeight: 500 }}>Buying Committee Fragility</span>
            </div>
      ...
      <div
        className="card"
        style={{
          background: "linear-gradient(135deg, #124548 0%, #082e30 100%)",
          color: "#ffffff",
          padding: "26px 30px",
          border: "none",
        }}
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 16 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: "12px", color: "#a5c2c4" }}>HubSpot Contact Association Graph</span>
            </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
        ...
        <div className="kpi-card" style={{ borderTopColor: "#00a4bd" }}>
          ...
          <div className="kpi-value" style={{ color: "#00a4bd" }}>2.4 / Deal</div>
