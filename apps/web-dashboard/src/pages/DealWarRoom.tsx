        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 16 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: "12px", color: "#a5c2c4" }}>Executive Deal Review</span>
            </div>
            ...
            <p style={{ fontSize: "13.5px", color: "#d9e8e8", margin: 0, maxWidth: 680 }}>
              Conduct QBR-grade Friday pipeline reviews. Rapidly drill into high-value at-risk deals and trigger executive multi-threading interventions.
            </p>
          </div>
        </div>
      </div>
